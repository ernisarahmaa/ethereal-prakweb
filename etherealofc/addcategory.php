...
<html lang="en">
  ...
  <body class="menuaddcategory">
    ...
    <form class="formtambahcategory" method="POST" action="inputcategory.php">
      <h1>Add Category</h1>
      <input type="text" name="category_name" placeholder="Input Category">
