...
<html lang="en">
  ...
  <body class="menuaddproduct">
    ...
    <form class="formaddproduct" method="POST" enctype="multipart/form-data" action="inputproduct.php">
      <h1>Add Product</h1>
      ...
      <input type="text" name="name" class="input-control" placeholder="Product Name">
      <input type="text" name="price" class="input-control" placeholder="Price">
      <textarea class="txt" name="description" placeholder="Description"></textarea>
      <input type="file" name="image" class="input-control" required>
      <select class="input-control ic2" name="status" required>
