  ...
  <body class="home">
    ...
    <table class="tabel table-bordered tabelmybag">
      ...
      <tbody>
        ...
        <?php $no++;?>
        <?php $totbel+=$totalharga; ?>
        <?php endforeach?>
      </tbody>
      <tfoot class="totalan">
      	<tr>
      		<td colspan="6" align="right"><b>Total</b></td>
      		<td>Rp. <?php echo number_format($totbel)?></td>
      	</tr>
      </tfoot>
  </table>
	...
	<form method="post">           
        ...
        <?php
            if(isset($_POST["checkout"])){
                ...
                //mengkosongkan keranjaang belanja
                unset($_SESSION["keranjang"]);

                echo "<script>alert('pembelian sukses');</script>";
                echo "<script>location='daftarproduk.php?id=$id_pembelian_barusan';</script>";
